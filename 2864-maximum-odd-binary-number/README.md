...
<p>You have to <strong>rearrange</strong> the bits in such a way that the resulting binary number is the <strong _msttexthash="27726361" _msthash="0">最大奇数二进制数</strong> that can be created from this combination.</p>
